...
from TextTonalModel.Python.Services.Logger import Logger
from TextTonalModel.Python.Services.Singleton import Singleton
...
class PathService(metaclass=Singleton):
    ...
    def _find_main_directory(self):
        self._path_to_main_directory = os.getcwd() + '/TextTonalModel'  # delete if run from TextTonalAnalyzer.py
        self.path_to_configs = os.path.join(self._path_to_main_directory, 'Python', 'Services', 'Configs')
        self.path_to_databases = os.path.join(self._path_to_main_directory, 'Databases')
    ...
    def configure(self):
        ...
        self.path_to_stop_words = os.path.join(self._path_to_main_directory, 'Python', 'Services', 'Lemmatizer',
                                               'stop_words.json')
        self._path_to_classifier_models = os.path.join(self.path_to_databases, 'Models')
        self.path_to_stop_words = os.path.join(self._path_to_main_directory, 'Python', 'Services', 'Lemmatizer',
                                               'stop_words.json')
        self._path_to_test_results = os.path.join(self._path_to_main_directory, 'Python', 'Tests', 'System', 'Reports')
